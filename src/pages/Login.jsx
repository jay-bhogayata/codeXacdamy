...
const Login = () => {
  return (
    <div className="flex  h-screen lg:flex-row  flex-col w-full ">
      <div className="lg:w-1/2  flex w-full h-1/3 lg:h-screen flex-col justify-around space-y-10 ">
        ...
        <img
          src={loginimg}
          alt=""
          className="lg:w-2/3 w-1/2 h-1/2 mx-auto lg:mt-0 mt-2"
        />
      </div>
      <div className="lg:w-1/2 md:w-2/3 mx-auto flex flex-col w-full h-1/2 lg:h-screen  lg:mt-0 mt-8 space-y-10 ">
        ...
        <div className="lg:mt-28 lg:mx-24 p-4 lg:p-0 space-y-4 flex flex-col sm:p-4 ">
          ...
          <p>Alrady have an account ? <a href="{#}" className="ml-3 text-blue-700 underline">Login</a></p>
          </div>
