...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      <p className="text-xl mx-auto mt-5"><Link to="/update-profile">Update Profile</Link></p>
        <button className="px-5 py-2 mt-4 w-full   bg-slate-700 mx-auto rounded-xl text-gray-100"
